                    ...
                    <table class="table" >
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr><td>{{ $category->id }}</td><td>{{ $category->name }}</td><td>{{ $category->slug }}</td><td><a href="{{ route('editcategory', $category->id) }}"><i class="fas fa-edit"></i> Edit</a> <a href="{{ route('deletecategory', $category->id) }}"><i class="fas fa-remove"></i> Remove</a> </td></tr>
                            @endforeach
                        </tbody>
                    </table>
                </div>
